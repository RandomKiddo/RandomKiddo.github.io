...
caption: Using stacked 3D MRI tensors to train a GPU-accelerated functional 3D CNN model for dementia classification.
description: >
  A classification model that would be able to detect if a patient has dementia, and its severity, based on a set of 61 layers of an MRI brain scan. The initial version of the project was turned in during an AI Hackathon competition hosted by Ohio State's AI Club, HackAI 2024.
  
  *Project image courtesy of [Kaggle](https://www.kaggle.com/datasets/ninadaithal/imagesoasis)*.
date: 28 Sep 2024
image: 
  path: /assets/img/projects/dataset-cover.webp
  srcset: 
    1920w: /assets/img/projects/dataset-cover.webp
    960w:  /assets/img/projects/dataset-cover.webp
    480w:  /assets/img/projects/dataset-cover.webp
links:
  - title: Link
    url: https://github.com/RandomKiddo/DementiaAI/tree/master
accent_color: '#4fb1ba'
accent_image:
  background: '#D6C69A'
theme_color: '#D6C69A'
...
Although this repository is being integrated with the Hack AI 2024 repository (meaning the files for this project will now also be there), the older version of the model can still be found by looking back in the commits [here](https://github.com/Nishanth-Kunchala/Hack_AI_2024).
...
<img src="/assets/img/projects/loss.webp" style="width: 80%; display: block; margin: 0 auto;" alt="Loss graph." />

The loss graph for the model, displaying a good overall shape.
{:.figcaption}

<img src="/assets/img/projects/accuracy.webp" style="width: 80%; display: block; margin: 0 auto;" alt="Accuracy graph." />

The accuracy graph for the model, displaying a good overall shape and high accuracy.
{:.figcaption}

The confusion matrix on the test set is shown below with relatively low errors:

<img src="/assets/img/projects/confusion_matrix.webp" style="width: 80%; display: block; margin: 0 auto;" alt="Confusion matrix." />
